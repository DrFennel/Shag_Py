'''
some_val = input('')
num = 2 if some_val else 3 if some_val == '' else 0
print(num)

'''

'''
number_max = -999_999_999
number_min = 999_999_999
counter = 0
while (number := int(input('input num: '))) != -1:
...
if counter != 0:  
    ...
    print('min - ', number_min)
else:
    print('Нou did not enter number!')
...
while True and counter != 100:
    print('in cycle', counter)
'''

'''
even = 0
odd = 0
while (number := int(input('input num: '))) != 0:
    if (number % 2) == 0:
        even +=1
    else:
        odd += 1
